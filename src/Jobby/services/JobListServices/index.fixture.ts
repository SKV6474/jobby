export const jobListFixtureDataList = [
  {
  ...
  },
  {
    ...
    location: "Chennai",
    job_description:
      "Facebooks’s Data Science team leverages big data to empower business decisions. The Data Science team at Facebook works in close partnership with the trusted engineering, content moderator, and product teams to identify opportunities to develop and enhance Facebook user experiences. ",
    employment_type: "Internship",
  ...
  },
  {
    ...
    location: "Mumbai",
    job_description:
      "As a DevOps Engineer, you will play a key role in bringing important software to market and into widespread use. In this role, you will integrate a variety of leading-edge technology stacks securely, and ensure the availability and safety of the production systems at scale.",
    employment_type: "Internship",
    package_per_annum: "12 LPA",
  },
  {
  ...
  },
  {
    ...
    location: "Bangalore",
    job_description:
      "We’re looking for a scientist who can define the next generation of FMA ML-based ranking, pricing, and econometric models to further improve customer experience and customer trust on Amazon. This scientist will work with tech and business teams within and outside of FMA to think outside the box and design innovative solutions.",
    employment_type: "Internship",
    package_per_annum: "12 LPA",
  },
  {
  ...
  },
  {
    ...
    location: "Chennai",
    job_description:
      "As an ML Engineer, you will get a chance to choose from a myriad of projects: building signals and models for detecting bad users and rejecting fraudulent and abusive contributions, building tools that allow Google operators to efficiently provide labels for model training and the infrastructure on which all of these run. ",
    employment_type: "Internship",
    package_per_annum: "13 LPA",
  },
  {
  ...
  },
  {
    ...
    location: "Hyderabad",
    job_description:
      "You will be part of a new team building a large-scale tier-1 rendering platform that supports as the skeleton for all the payment pages to depend, host, and render on, in Amazon Pay. This new system will be utilized by thousands of customers every day. ",
    employment_type: "Internship",
    package_per_annum: "12 LPA",
  },
  {
  ...
  },
  {
    ...
    location: "Bangalore",
    job_description:
      "The Developer platform team enables Swiggy's engineers to build and run services in the cloud in a safe, simple, and reliable manner. We are a team of systems and software engineers who thrive to develop Platforms and services that make it easier for product teams to build and operate their services.",
    employment_type: "Internship",
  ...
  },
  {
    ...
    location: "Chennai",
    job_description:
      "We are looking for a passionate, hands-on engineer to join the Engineering team. Work closely with designers to implement versatile front-end solutions while embracing emerging standards and pushing the limits of what a browser can do. You will be responsible for building next-generation web applications which are efficient and reusable.",
    employment_type: "Internship",
    package_per_annum: "14 LPA",
  },
  {
